<template>
    <div class="miui-swipe">
        <div class="miui-swipe-items-wrap" ref="wrap">
            <slot></slot>
        </div>
        <div class="miui-swipe-indicators" v-show="showIndicators">
            <div class="miui-swipe-indicator" v-for="(page, $index) in pages" :class="{ 'is-active': $index === index }"></div>
        </div>
    </div>
</template>
<script>
...
.miui-swipe-items-wrap {
    position: relative;
    overflow: hidden;
    height: 100%;
}

.miui-swipe-items-wrap > div {
    position: absolute;
...
.miui-swipe-items-wrap > div.is-active {
    display: block;
    -webkit-transform: none;
    transform: none;
}

.miui-swipe-indicators {
    position: absolute;
    bottom: 10px;
    left: 50%;
...
.miui-swipe-indicator.is-active {
    background: #fff;
}
</style>
