<template>
    <div @touchstart="startDrag" @mousedown="startDrag" @touchmove="onDrag" @mousemove="onDrag" @mouseleave="endDrag" @touchend="endDrag" class="miui-tab-container">
        <div ref="wrap" class="miui-tab-container-wrap">
            <slot></slot>
        </div>
    </div>
</template>
...
.miui-tab-container .swipe-transition {
 ...
 *
 * @example
 * <mic-tab-container v-model="selected">
 *   <mic-tab-container-item id="1"> 内容A </mic-tab-container-item>
 *   <mic-tab-container-item id="2"> 内容B </mic-tab-container-item>
 *   <mic-tab-container-item id="3"> 内容C </mic-tab-container-item>
 * </mic-tab-container>
 */
export default {
    name: 'mic-tab-container',
